...
const { push } = useToast()
const existing = route.params.slug ? findProduct(route.params.slug) : null
...
<template>
  <div>
    <router-link to="/admin/produk" class="inline-flex items-center gap-2 text-[0.8rem] text-muted transition hover:text-forest">
