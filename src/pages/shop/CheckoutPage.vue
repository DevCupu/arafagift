...
import { paymentMethods, shippingMethods } from '@/data/content'
...
const shipping = computed(() => shippingMethods.find((s) => s.id === form.shipping))
    ...
    <div v-if="cart.items.value.length" class="mx-auto grid max-w-6xl lg:grid-cols-[1.2fr_1fr]">
      ...
      <div class="px-5 py-10 sm:px-10 lg:py-14">
        <div class="flex items-center justify-between">
          <BrandLogo size="sm" />
          <router-link to="/keranjang" class="flex items-center gap-1.5 text-[0.78rem] text-muted transition hover:text-forest">
